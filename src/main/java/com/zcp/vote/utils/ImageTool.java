...
public class ImageTool {
	...
	public void createFileIconImage(String destOutPath) {
		...
		PropertiesTool propertiesTool = PropertiesTool
				.getInstance(StaticConstants.SHARE_FILE_CONFGURATION_PROPERTIES_PATH);
		// get share file root path
		String shareFileRootPath = propertiesTool
				.getPropertiesValue("FileShareRootPath");
		// root dictory
		...
		if (fileList != null && fileList.length > 0) {
			...
			for (int i = 0, j = fileList.length; i < j; i++) {
				...
				ImageIcon fileIcon = (ImageIcon) FileSystemView
				...
				String fileNameX = fileName.substring(0,
	 ...
	 */
	public void graphicsGeneration(String imgurl, String imageOutPathName,
			int variableParmeterLength, String... drawString) {
